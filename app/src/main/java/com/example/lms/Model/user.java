...
public class user {
    ...
    public void setWatch_history(String watch_history) {
    ...
    public String getPaypal_keys() {
        return paypal_keys;
    }

    public void setPaypal_keys(String paypal_keys) {
        this.paypal_keys = paypal_keys;
    }
